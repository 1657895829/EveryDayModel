...
/** 
 * DAO for table "FIRST_BEAN".
*/
public class FirstBeanDao extends AbstractDao<FirstBean, Long> {

    public static final String TABLENAME = "FIRST_BEAN";
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"FIRST_BEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"FIRST_BEAN\"";
        db.execSQL(sql);
    }
